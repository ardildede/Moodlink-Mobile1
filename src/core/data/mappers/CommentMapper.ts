...
export class CommentMapper {
  ...
  /**
   * Maps post comments API response to Comment entity
   */
  static postCommentToEntity(dto: any): Comment {
    console.log("CommentMapper.postCommentToEntity - API response:", dto);
    ...
    return {
      ...
      user: {
        id: dto.userId,
        userName: dto.userName || "Kullanıcı",
        firstName: "",
        lastName: "",
