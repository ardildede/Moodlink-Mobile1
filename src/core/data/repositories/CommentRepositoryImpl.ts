...
export class CommentRepositoryImpl implements ICommentRepository {
  ...
  async getComments(params: GetCommentsUseCaseParams): Promise<Comment[]> {
    ...
    return response.comments.map(CommentMapper.postCommentToEntity);
  }
  ...
  async likeComment(
    userId: string,
    commentId: string
  ): Promise<{ id: string; userId: string; commentId: string }> {
    // Placeholder implementation - this would need to be implemented based on your API
    throw new Error("likeComment method not implemented");
  }

  async unlikeComment(userId: string, commentId: string): Promise<void> {
    // Placeholder implementation - this would need to be implemented based on your API
    throw new Error("unlikeComment method not implemented");
  }
}
